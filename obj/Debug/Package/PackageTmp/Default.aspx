...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <table style = "width : 100%; text-decoration:none; font-size:25px" >
        <tr>
            ...
            <th>
                <asp:Button ID="ApplyNow" runat="server" Text="APPLY NOW" BackColor="#CC0000" ForeColor="#FFFFCC" Font-Bold ="true" OnClick="ApplyNow_Click"/></th>
            <th>
                <asp:Button ID="Button2" runat="server" Text="SIGIN IN" BackColor="#006600" ForeColor="White" Font-Bold ="true" OnClick="Button2_Click" /></th>         
        </tr>
    </table> 
   <script>
       function alertBox() {
